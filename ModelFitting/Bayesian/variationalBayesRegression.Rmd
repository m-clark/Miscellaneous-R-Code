...
I will use the notation in Drugowitsch in most cases. Here w, represents the coefficients, and τ the precision (inverse variance). The likelihood for response y is N(Xw, τ^-1). Priors for w and tau are normal inverse gamma N(0, (τα)^-1) Gamma(a0,b0). 
