...
## copmared to reported paper estimates for phi and topicmodel package (note
## delta is beta above; the vignette actually references Steyvers & Griffiths
## paper)
library(topicmodels)
ldaout = LDA(dtm, k=2, method='Gibbs', control=list(alpha=alpha, delta=.01, iter=5500, burnin=500, thin=10, initialize='random'))
