# ----------------------------------------------------------------------------------#
# The following is an EM algorithm for probabilistic principal components analysis. #
# Based on Tipping and Bishop, 1999, and also Murphy 2012 Probabilistic ML.  See    #
# also ModelFitting/EM Examples/EM for pca.R                                        #
# ----------------------------------------------------------------------------------#
